const WebDevCard = () => {
  const skills = ["React", "Node.js", "Python", "MongoDB", "Responsive Design"];
    ...
    >
      <div className="mb-3 flex flex-wrap items-center justify-between gap-2 sm:mb-6 sm:gap-3">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <span className="inline-flex items-center gap-2 rounded-full bg-primary/10 px-2 py-0.5 text-[10px] font-semibold text-primary sm:px-3 sm:py-1 sm:text-xs">
          ...
          <span className="rounded-full bg-primary/10 px-2 py-0.5 text-[10px] font-semibold text-primary sm:px-3 sm:py-1 sm:text-xs">
            Web Dev Agent
          </span>
        </div>
      </div>
      ...
      <p className="mt-1.5 text-[11px] text-dark/70 sm:mt-2 sm:text-sm">
        Modern web applications engineered for speed, scalability, and
        conversion.
      </p>
      <details className="mt-2.5 hidden sm:block sm:mt-4">
        ...
        <p className="mt-2 text-[11px] text-dark/70 sm:text-sm">
          Specializes in fast builds, clean architecture, and integrations that
      ...
      <div className="mt-4 hidden rounded-2xl border border-gray/70 bg-gray/40 p-2.5 text-[11px] text-dark/70 sm:block sm:mt-6 sm:p-4 sm:text-sm">
        ...
        <ul className="mt-2 grid gap-2">
          <li className="flex items-center gap-2">
            ...
            Launch-ready MVPs in 2-4 weeks
          </li>
          <li className="flex items-center gap-2">
            <span className="h-2 w-2 rounded-full bg-secondary" />
            Performance budgets and SEO baked in
          </li>
          <li className="flex items-center gap-2">
            <span className="h-2 w-2 rounded-full bg-primary" />
            Automated QA and deployment pipelines
          </li>
        </ul>
      </div>
      <div className="mt-4 hidden grid-cols-1 gap-2 text-[11px] sm:grid sm:mt-6 sm:grid-cols-2 sm:gap-4 sm:text-sm">
        ...
        <div>
          ...
          <p className="font-semibold text-dark">6+</p>
        </div>
      </div>
      <div className="mt-4 flex flex-wrap gap-2 sm:mt-6 sm:gap-3">
        <a
          href="#portfolio"
          className="inline-flex w-full items-center justify-center gap-2 rounded-full bg-accent px-3 py-1.5 text-[11px] font-semibold text-dark transition group-hover:shadow-lg sm:w-auto sm:px-5 sm:py-2 sm:text-sm"
        >
          View Portfolio
        </a>
        <a
          href="#contact"
          className="inline-flex w-full items-center justify-center gap-2 rounded-full border border-accent/60 px-3 py-1.5 text-[11px] font-semibold text-accent transition group-hover:border-accent group-hover:text-dark group-hover:bg-accent sm:w-auto sm:px-5 sm:py-2 sm:text-sm"
        >
          Book a Call
        </a>
      </div>
